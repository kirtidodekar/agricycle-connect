...
const BuyerPrivacy = () => {
  const [privacySettings, setPrivacySettings] = useState({
    ...
    businessInformationVisibility: true
  });
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Show details about your business</p>
                </div>
              </div>
              <Switch
                checked={privacySettings.businessInformationVisibility}
                onCheckedChange={() => handlePrivacyChange('businessInformationVisibility')}
              />
            </div>
          </div>
        </div>
