  ...
  const conversations = [
    {
      id: 1,
      name: "Rajesh Kumar",
      lastMessage: "Hello! Is the rice husk still available?",
      time: "2h ago",
      unread: 2,
      avatar: "RK",
    ...
    },
    {
      id: 2,
      name: "Amit Patil",
      lastMessage: "Yes, we can arrange pickup for tomorrow",
      time: "5h ago",
      unread: 0,
      avatar: "AP",
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-xl bg-secondary/10 flex items-center justify-center">
                  <span className="text-lg font-bold text-secondary">{conversation.avatar}</span>
                </div>
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground mb-1">{conversation.crop} • {conversation.location}</p>
                  <div className="flex items-center justify-between">
                    ...
                    {conversation.unread > 0 && (
                      <span className="w-5 h-5 rounded-full bg-secondary flex items-center justify-center">
                        <span className="text-xs font-bold text-secondary-foreground">{conversation.unread}</span>
                      </span>
                    )}
                  </div>
                </div>
